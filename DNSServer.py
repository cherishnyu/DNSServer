...
password = 'your.nyu.email@nyu.edu'  # Placeholder: Replace with your actual NYU email address registered in Gradescope
...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (str(encrypted_value),),  # A string cast version of your encrypted secret data
    ...
    while True:
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                # Add all matching RDATAs to the response's answer section
                for rdata in rdata_list:
                    # Create the record set (RRset)
            ...
            response.flags |= dns.flags.RA  # Also commonly set for simple DNS servers (Recursive Available)
